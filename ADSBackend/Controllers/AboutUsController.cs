...
namespace ADSBackend.Controllers
{
    public class AboutUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AboutUsId,aBout")] AboutUs aboutUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AboutUsId,aBout")] AboutUs aboutUs)
        {
